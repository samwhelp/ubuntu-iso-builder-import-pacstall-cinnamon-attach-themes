...
# ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes
...
| `+` |
| [ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes) |
| `=` |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes`

``` sh
cd ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-vimix-attach-themes/iso-profile/dist`
